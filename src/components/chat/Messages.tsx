...
export default function Messages({fileId}:messagingProps){
    ...
    },
    {
       ...
       //keepPreviousData: tru e as any,
      }

    )
    // return type will be an array of array
    ...
    // display a loading state message
